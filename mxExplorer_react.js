javascript: (() => {
    ...
    mxExplorer.body = document.getElementsByTagName("body")[0];
    mxExplorer.head = document.getElementsByTagName("head")[0];
    ...
    function afterLoadNPEntities() {
        ...
        mxExplorer.modal.closeButton.addEventListener("click", event => {
            ...
            mxExplorer.head.removeChild(mxExplorer.style);
            mxExplorer = null
        });
